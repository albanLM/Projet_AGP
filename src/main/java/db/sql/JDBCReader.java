...
public class JDBCReader {
    final private Connection dbConnection = DatabaseConnection.getConnection();
    ...
    public Place readPlace(int id) throws SQLException {
        ...
        PreparedStatement placeStatement = dbConnection.prepareStatement(placeQuery);
        placeStatement.setInt(1, id);
        ResultSet resultPlace = placeStatement.executeQuery();
        if (resultPlace.next()) {
            PreparedStatement coordsStatement = dbConnection.prepareStatement(coordsQuery);
    ...
    public TransportMethod readTransportMethod(int id) throws SQLException {
        ...
        PreparedStatement transportStatement = dbConnection.prepareStatement(transportQuery);
    ...
    public Hotel readHotel(int id) throws SQLException {
        ...
        PreparedStatement hotelStatement = dbConnection.prepareStatement(hotelQuery);
    ...
    public Visit readVisit(int id) throws SQLException {
        ...
        PreparedStatement visitStatement = dbConnection.prepareStatement(visitQuery);
